                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    {{ Form::textarea('description', '', [ 'class' => 'form-control', 'placeholder' => trans('Description'), 'id' => 'description', 'rows' => 2]) }}
                                </div>
                                ...
                                <table class="table table-striped"
                                    ...
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th scope="col" data-field="description" data-align="center" data-sortable="false"> {{ __('Description') }}</th>
                    ...
                    <form action="{{ url('package') }}" class="edit-form" enctype="multipart/form-data" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                {{-- Description --}}
                                <div class="col-12 form-group">
                                    {{ Form::label('edit-description', __('Description'), ['class' => 'form-label text-center']) }}
                                    {{ Form::textarea('description', '', [ 'class' => 'form-control', 'placeholder' => trans('Description'), 'id' => 'edit-description', 'rows' => 2]) }}
                                </div>
                            </div>
                        </div>
